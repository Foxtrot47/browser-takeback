...
void BraveAddCommonStrings(content::WebUIDataSource* html_source,
  ...
  webui::LocalizedString localized_strings[] = {
      ...
      {"siteSettingsUserControl", IDS_SETTINGS_SITE_SETTINGS_USER_CONTROL},
      {"siteSettingsCategoryUserControl",
       IDS_SETTINGS_SITE_SETTINGS_USER_CONTROL},
      {"siteSettingsUserControlMaster",
       IDS_SETTINGS_SITE_SETTINGS_USER_CONTROL_MASTER},
      {"siteSettingsUserControlDescription",
       IDS_SETTINGS_SITE_SETTINGS_USER_CONTROL_DESCRIPTION},
      {"siteSettingsUserControlProtect",
       IDS_SETTINGS_SITE_SETTINGS_USER_CONTROL_PROTECT},
      {"siteSettingsUserControlAllow",
       IDS_SETTINGS_SITE_SETTINGS_USER_CONTROL_ALLOW},
      {"siteSettingsUserControlProtectDefault",
       IDS_SETTINGS_SITE_SETTINGS_USER_CONTROL_PROTECT_DEFAULT},
      {"siteSettingsUserControlAllowDefault",
       IDS_SETTINGS_SITE_SETTINGS_USER_CONTROL_ALLOW_DEFAULT},
      {"siteSettingsUserControlProtectExceptions",
       IDS_SETTINGS_SITE_SETTINGS_USER_CONTROL_PROTECT_EXCEPTIONS},
      {"siteSettingsUserControlAllowExceptions",
       IDS_SETTINGS_SITE_SETTINGS_USER_CONTROL_ALLOW_EXCEPTIONS},
      {"siteSettingsUserControlPageExit",
       IDS_SETTINGS_SITE_SETTINGS_USER_CONTROL_PAGE_EXIT},
      {"siteSettingsCategoryUserControlPageExit",
       IDS_SETTINGS_SITE_SETTINGS_USER_CONTROL_PAGE_EXIT},
      {"siteSettingsUserControlPageExitDescription",
       IDS_SETTINGS_SITE_SETTINGS_USER_CONTROL_PAGE_EXIT_DESCRIPTION},
      {"siteSettingsUserControlPageExitProtect",
       IDS_SETTINGS_SITE_SETTINGS_USER_CONTROL_PAGE_EXIT_PROTECT},
      {"siteSettingsUserControlPageExitAllow",
       IDS_SETTINGS_SITE_SETTINGS_USER_CONTROL_PAGE_EXIT_ALLOW},
      {"siteSettingsUserControlPageExitProtectDefault",
       IDS_SETTINGS_SITE_SETTINGS_USER_CONTROL_PAGE_EXIT_PROTECT_DEFAULT},
      {"siteSettingsUserControlPageExitAllowDefault",
       IDS_SETTINGS_SITE_SETTINGS_USER_CONTROL_PAGE_EXIT_ALLOW_DEFAULT},
      {"siteSettingsUserControlPageExitProtectExceptions",
       IDS_SETTINGS_SITE_SETTINGS_USER_CONTROL_PAGE_EXIT_PROTECT_EXCEPTIONS},
      {"siteSettingsUserControlPageExitAllowExceptions",
       IDS_SETTINGS_SITE_SETTINGS_USER_CONTROL_PAGE_EXIT_ALLOW_EXCEPTIONS},
